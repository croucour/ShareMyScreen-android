...
// */
//public class OrganizationActivity extends MyActivityDrawer implements View.OnClickListener, IOrganizationView, TextWatcher{
...
////            profileEntity.set_public_id("007");
...
////            profileEntity2.set_public_id("009");
...
////
////        _adapterOrganization = new AdapterOrganization(_manager._organizationManager, _userEntity._profileEntity.get_public_id(), this);
////
...
//
//        _viewDialogInvit = this.getLayoutInflater().inflate(R.layout.members_invitation, null, false);
//
...
//        _viewDialogMembers = this.getLayoutInflater().inflate(R.layout.members_list, null, false);
//
...
//                _adapterOrganizationMembers.set_typeList(action);
//                break;
//            case "members" :
...
//            closeDialog("members");
//        }
//        else if (_dialogCreate.isShowing()) {
//            closeDialog("create");
//        }
//        else {
//            super.onBackPressed();
